<?php
/**
 * @version		$Id: location.php 21148 2011-04-14 17:30:08Z ian $
...
class AlveariumModelLocation extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Location', $prefix = 'AlveariumTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_alvearium.location', 'location', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
